...
if &background == "dark"
  ...
  SynColor Constant	term=underline cterm=NONE ctermfg=227 ctermbg=NONE gui=NONE guifg=Magenta guibg=NONE
  SynColor Str cterm=NONE ctermfg=DarkRed ctermbg=NONE gui=NONE guifg=Magenta guibg=NONE
  SynColor Special	term=bold cterm=NONE ctermfg=DarkMagenta ctermbg=NONE gui=NONE guifg=SlateBlue guibg=NONE
  SynColor Identifier	term=underline cterm=NONE ctermfg=214 ctermbg=NONE gui=NONE guifg=DarkCyan guibg=NONE
  SynColor Statement	term=bold cterm=bold ctermfg=026 ctermbg=NONE gui=bold guifg=Brown guibg=NONE
  SynColor PreProc	term=underline cterm=NONE ctermfg=DarkMagenta ctermbg=NONE gui=NONE guifg=Purple guibg=NONE
  SynColor Type		term=underline cterm=NONE ctermfg=129 ctermbg=NONE gui=bold guifg=SeaGreen guibg=NONE
...
SynColor Csb cterm=bold ctermfg=051 ctermbg=NONE gui=NONE guifg=White guibg=Red
SynColor StorageClass cterm=bold ctermfg=white ctermbg=NONE gui=NONE guifg=White guibg=Red
